...
export function PreviewFrame() {
  ...
  if (error) {
    if (error === "firstLoad") {
      return (
        <div className="h-full flex items-center justify-center p-8 bg-gradient-to-br from-slate-50 via-white to-violet-50">
          <div className="text-center max-w-md">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br from-violet-500 to-fuchsia-500 mb-6 shadow-xl shadow-violet-500/25">
              <svg
            ...
            <h3 className="text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-600 mb-3">
    ...
    return (
      <div className="h-full flex items-center justify-center p-8 bg-gradient-to-br from-slate-50 via-white to-rose-50">
        <div className="text-center max-w-md">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br from-slate-200 to-slate-300 mb-6 shadow-lg">
            <AlertCircle className="h-10 w-10 text-slate-500" />
          </div>
          <h3 className="text-xl font-bold tracking-tight text-slate-800 mb-3">
